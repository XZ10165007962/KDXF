...
if __name__ == '__main__':
	...
	for i in range(1, 13):
		...
		model = RandomForestRegressor(max_depth=10, min_samples_leaf=2, random_state=2022).fit(train_data_x,train_data_y)
		lgb_test = model.predict(test_data_x)
		# 反归一化
